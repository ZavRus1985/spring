...
public class ApplicationMain {
    ...
    public static void main(String[] args) {
        ...
        Car car = new Car(null,"Supra", new BigDecimal("2002.23"), "Toyota", 2000, LocalDate.of(2022,12,11));
...
//        System.out.println(carRepository.getCarById(1L).map(Car::getPrice));
//
        System.out.println("car by filter");
        carRepository.getCarByFilter(1000L).stream().map(Car::getModel).forEach(System.out::println);
//
